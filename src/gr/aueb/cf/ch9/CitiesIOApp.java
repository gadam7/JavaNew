...
/**
 * Διαβάζει από ένα αρχείο με μορφή δεδομένων country1 city1 city2 city3...
...
public class CitiesIOApp {
    ...
    public static void main(String[] args) {
        String line;
        String[] cities;
        File dir = new File("/Users/adminmacbook/IdeaProjects");
        ...
        try (BufferedReader bf = new BufferedReader(new FileReader("/Users/adminmacbook/IdeaProjects/cities.txt"))) {
