 ...
 * @version 2.0
 */
public class Mobile2App {
    final static Scanner in = new Scanner(System.in);
    final static Path path = Paths.get("/Users/adminmacbook/IdeaProjects/logMobile.txt");
    ...
    public static void handleChoiceController(String s) {
        ...
        try {
            ...
            if (!isValid(choice)) {
                throw new IllegalArgumentException("Error - Choose between 1 - 5");
            }
    ...
    public static void printContactMenu() {
        System.out.println("Insert Firstname, Lastname and Mobile Number: ");
    }
    ...
    public static String getPhoneNumber() {
        System.out.println("Insert Mobile Phone Number: ");
        return in.nextLine().trim();
    }
