 ...
 * διαβάζει να εκτυπώνει τον μέγιστο αριθμό αυτοκινήτων που είναι σταθμευμένα το ίδιο χρονικό
 * διάστημα. Ως παράδειγμα στον παραπάνω πίνακα το αποτέλεσμα θα πρέπει να είναι: 2. Το 1ο αυτοκίνητο
 * αφίχθη στις 10:12 και αναχώρησε στις 11:36, το 3ο αυτοκίνητο αφίχθη στις 10:15 και αναχώρησε στις
 * 10:20. Επομένως, το 1ο και το 3ο αυτοκίνητο ήταν παρόντα το ίδιο χρονικό διάστημα.
 *
 ...
 * αυτοκινήτων που είναι σταθμευμένο το ίδιο χρονικό διάστημα με ένα πέρασμα του πίνακα.
 */
...
public class MaxCarArrivalsApp {
     ...
     * into a x2 2D array; one row for departure and one for arrival.
     * The second column involves 1 for arrival and 0 for departure.
     *
     * @param arr   the source array
     * @return      the trnsformed array
     */
