...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("/Users/adminmacbook/IdeaProjects/lotto5in.txt"));
             PrintStream ps = new PrintStream("/Users/adminmacbook/IdeaProjects/lotto5out.txt", StandardCharsets.UTF_8)) {
