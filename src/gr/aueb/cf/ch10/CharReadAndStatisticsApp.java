...
/**
 * Αναπτύξτε μια εφαρμογή που διαβάζει έναν-έναν τους χαρακτήρες ενός αρχείου
...
public class CharReadAndStatisticsApp {
    final static Path path = Paths.get("/Users/adminmacbook/IdeaProjects/logTextStatistics.txt");
    ...
    public static void readTextAndSaveService() throws IOException, IllegalArgumentException {
        ...
        try (FileInputStream fs = new FileInputStream("/Users/adminmacbook/IdeaProjects/inputText.txt");) {
