...
public class OrangeRedSignalApp {
    ...
    public static void main(String[] args) {
        ...
        orangeOn = isTank1LTQuarter || isTank2LTQuarter; //με XOR θα άναβε μόνο το κόκκινο και όχι και το
        redOn = isTank1LTQuarter && isTank2LTQuarter; //πορτοκαλί στην περίπτωση που είναι και τα δύο tank < 1/4
